<div class="wrap spotim-page-wrap">
    ...
    <nav class="nav-tab-wrapper">
        ...
        <a href="<?php echo esc_attr( '?page=' . $this->slug . '&tab=import'   ); ?>" class="nav-tab <?php echo ( 'import'   === $this->active_tab ) ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Comments Sync',  'spotim-comments' ); ?></a>
